  ...
  const benefits = [
    {
      ...
      description: "Every line of code is open for inspection. No hidden telemetry.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: "Privacy First",
      description: "Your voice never leaves your device unless you choose cloud mode.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Built by developers, for developers. Shape the roadmap with us.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">
                Built in the <span className="font-serif italic text-primary">open</span>
              </h2>
              <p className="text-base text-muted-foreground">
                Transparency and privacy aren't just features - they're our foundation. Dicta is 100% open source and always will be.
              </p>
            </div>
            ...
            <div className="grid gap-4">
              {benefits.map((benefit, index) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-primary/20 border border-primary/30 flex items-center justify-center text-primary flex-shrink-0 group-hover:scale-110 transition-transform">
                    {benefit.icon}
                  </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-foreground text-background rounded-xl font-semibold text-sm hover:bg-foreground/90 transition-all hover:scale-105"
              >
